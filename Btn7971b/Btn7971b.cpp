...
yh::rec::Btn7971b::Btn7971b (const uint16_t init_pwm_and_dir_pin) :
    pwm_pin(init_pwm_and_dir_pin >> 8), dir_pin(init_pwm_and_dir_pin & 0xff), speed(0), slowest_spd(-255), fastest_spd(255)
{
    pwm_pin_mask = digitalPinToBitMask(pwm_pin);
    pwm_pin_output_register = portOutputRegister(digitalPinToPort(pwm_pin));
    pwm_pin_timer = digitalPinToTimer(pwm_pin);
